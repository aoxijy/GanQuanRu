...
# 添加第三方软件包
git clone https://github.com/aoxijy/jac-package package/jac-package
...
sed -i "s/OpenWrt /GanQuanRu$(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ              # 增加自己个性名称
...
# ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●● #
sed -i 's#%D %V, %C#%D %V, %C GanQuanRu#g' package/base-files/files/etc/banner               # 自定义banner显示
...
# 下载TUN内核
  ...
  wget -q https://raw.githubusercontent.com/vernesong/OpenClash/core/master/premium/clash-linux-amd64-2023.03.04.gz
  if [[ $? -ne 0 ]];then
...
CONFIG_PACKAGE_luci-app-ddns-go=y #DDNS解析服务
